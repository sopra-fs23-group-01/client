...
const Profile= () =>{
  ...
  const [selectedBirthDate, setSelectedBirthDate] = useState(new Date('2023-03-02'));
    ...
    return (
      <div className="profile container">
        ...
        <div className="profile username">
            ...
            <DatePicker selected={selectedBirthDate} onChange={handleDateChange} />
                {selectedBirthDate && (
                <p>
  ...
  const doEditProfile = async () => {
    try {
      const requestBody = JSON.stringify({username, selectedBirthDate});
