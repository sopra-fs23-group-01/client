...
const Profile= () =>{
  ...
  const Profilefield = propTypes => {
    const statusStyle = {
      color: propTypes.status === "ONLINE" ? "green" : "red"
    };
      ...
      <div className="profile container">
        ...
        <div className="profile username">Username:
            <input 
                ...
                placeholder={propTypes.username}
                value={propTypes.value}
                onChange={e => propTypes.onChange(e.target.value)}
            />
            </div>
        
        <div className="profile name">Creation date:  {propTypes.registerDate}</div>
        ...
        <div className="profile name">
            Online status:
          <span style={statusStyle}>   {propTypes.status}</span>
        </div>
      </div>
