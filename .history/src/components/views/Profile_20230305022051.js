...
const ProfilePage=() =>{
  ...
  function Profilefield({functionuser}) {
    ...
    const formatDate = (dateString) => {
      if(dateString!==null){
        const [year, month, day, hour, minute] = dateString.match(/\d+/g);
    ...
    return (
      <div className="profile container">
        ...
        <div className="profile name">Creation date:  {functionuser.birthday}</div>
        <div className="profile name">Birthday:  {formatDate(functionuser.birthday)}</div>
