...
const UsernameEditfield = props=> {

      
    return (
      <div className="profile container">
        
        <div className="profile username"> UserID:  {props.id}</div>
        ...
        <div className="profile name">Creation date:  {props.registerDate}</div>
        </div>
        );
        }

const BirthdayEditfield = props=> {
    const statusStyle = {
    ...
    return(
        ...
        <div className="profile username">
            Birthday: 
            <DatePicker selected={props.birthday} onChange={e => props.onChange(e.target.value)} />
                {props.birthday && (
                <p>
                Your Selected Birthday is{' '}
                    {`${props.birthday.getFullYear()}-${
                        props.birthday.getMonth() + 1
  ...
  UsernameEditfield.propTypes = {
    id: PropTypes.string,
    value: PropTypes.string,
    registerDate: PropTypes.string,
    onChange: PropTypes.func
  };
  BirthdayEditfield.propTypes = {
