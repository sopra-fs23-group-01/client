...
function Profilefield({ user }) {
            ...
            return (
              ...
              <div className="profile container">
                ...
                <div className="profile username"><a href={`/profile/${user.id}`} className="player namelink"> Username:{user.username}</a></div>
                <div className="profile name">Password:{user.password}</div>
                <div className="profile name">Creat time:{user.registerDate}</div>
