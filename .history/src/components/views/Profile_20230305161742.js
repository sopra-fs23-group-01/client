...
const ProfilePage=() =>{
  ...
  function Profilefield({functionuser}) {
    ...
    const formattedBirthday = (functionuser.birthday).split(" ")[0];
  
    return (
      <div className="profile container">
        <div> {formatDate(functionuser.birthday)}</div>
        ...
        <div className="profile name">Birthday:  {formattedBirthday}</div>
